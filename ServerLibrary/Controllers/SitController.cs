...
namespace ServerLibrary.Controllers
{
    ...
    public class SitController : Controller
    {
        ...
        public SitController(ILogger<SitController> logger, SMSSGsoClient SMSGso, AsoDataClient ASOData, SMDataServiceClient SMData, SMP16xClient SMP16x, UUZSDataClient UUZSData, WriteLog log, StaffDataClient StaffData, SMControlSysClient SMContr, AuthorizedInfo userInfo)
        {
            _logger = logger;
            _SMSGso = SMSGso;
            _ASOData = ASOData;
